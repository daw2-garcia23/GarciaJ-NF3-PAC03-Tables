...
VALUES 
    (4, "2008-09-28", "Peppermint Patty", "I wish I'd have seen it
        sooner!", 3),
    (3, "2008-09-23", "Marvin Martian", "This is my favorite movie. I
        didn't wear my flair to the movie but I loved it anyway.", 6),
    (2, "2008-09-23", "George B.", "I liked this movie, even though I
        Thought it was an informational video from my travel agent.", 9)
ENDSQL;
mysqli_query($db,$query) or die(mysqli_error($db));
